...
public class ClientThread extends Thread
{
	...
	public void run() {
		if (count > 0) {
            //neue besichtigung anfordern
            clientForm.addLog("Visit with " + count + " visitors requested...");
            guidesMonitor.request(); //falls kein fuehrer frei
            ...
            try (Socket socket = new Socket(HOST, PORT);
                ...
                clientForm.addActiveVisitToList(count);
                clientForm.addLog("Visit with " + count + " visitors enter the tunnel");
                
            } catch (Exception e) {
                //bei fehler fuhrer zurückgeben
            ...
            int releaseCount = Math.abs(count);
            guidesMonitor.release();
            ...
            try (Socket socket = new Socket(HOST, PORT);
                ...
                out.writeInt(count); //negative Anzahl schicken
                in.readInt(); //auf bestätigung warten
                
                clientForm.removeActiveVisitFromList(releaseCount);
                clientForm.addLog("Visit with " + releaseCount + " visitors finished");
            ...
            try (Socket socket = new Socket(HOST, PORT);
                ...
                clientForm.updateAvailableVisitorsLabel(available);
	...
	public void behandleException(Exception e) {
		System.err.println("Client Netzwerkfehler: " + e.getMessage());
	}
}