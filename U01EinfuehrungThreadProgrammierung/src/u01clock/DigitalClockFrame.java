...
import u01threads.MinMaxAvgSearch;
...
public class DigitalClockFrame extends JFrame {
	...
	private DigitalClockLabel clock = null;
	...
	public DigitalClockFrame() {
		...
		clock = new DigitalClockLabel(clockLabel);	// DigitalClockLabel Objekt welche die Uhrzeit im clockLabel ausgibt
